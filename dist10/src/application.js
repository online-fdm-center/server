...
class OnlineFdmCenterApplication extends boot_1.BootMixin(service_proxy_1.ServiceMixin(repository_1.RepositoryMixin(rest_1.RestApplication))) {
    constructor(options = {}) {
        super(options);
...
exports.OnlineFdmCenterApplication = OnlineFdmCenterApplication;
